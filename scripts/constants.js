	...
	'Hanzo': [
		{
			...
			'Stage': "Battle of Nagashino",
			'Requirement': "Within 10 minutes succeed in the missions 'Defend Nagashino Castle', 'Defend the Maruyama Garrison', defeat Katsuyori Takeda, and kill 200 enemies."
		}
	],
	'Ranmaru': [
		{
	...
	'Ina': [
		{
			...
			'Requirement': "Complete the first two missions, then when the mission of eliminating the Asakura officers becomes available score 1000 KOs. before completing it, all without suffering losses. The supply team will appear in the northwest and heads south."
		}, {
			'Game': "SW",
			'Name': "Aisen",
			'Rank': 6,
